...
namespace Tendeos.Utils.Input
{
    public static class Keyboard
    {
        ...
        public static bool IsUp(Keys key) => currentKeyState.IsKeyUp((XNAKeys)key);
        public static bool IsReleased(Keys key) => currentKeyState.IsKeyUp((XNAKeys)key) && !previousKeyState.IsKeyUp((XNAKeys)key);
        public static bool IsDown(Keys key) => currentKeyState.IsKeyDown((XNAKeys)key);
