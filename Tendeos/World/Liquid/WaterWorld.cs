...
using PrimitiveType = Tendeos.Utils.Graphics.PrimitiveType;

namespace Tendeos.World.Liquid
{
    public class WaterWorld
    {
        ...
        public WaterWorld(GraphicsDevice graphicsDevice, int width, int height, Camera camera, int chunkSize)
        {
        ...
        public void Tick()
        {
            // set the update position to left-up corner of the map
            var (selfx, selfy) = Map.World2Cell(camera.Position - camera.WorldViewport / 2);
            selfx -= 2;
            selfy -= 2; // move it to left-up for 2 tiles,

            int width = viewWidth + Map.ChunkSize * 6; // set update width to 6 chunks
            int height = viewHeight + Map.ChunkSize * 6; // set update height to 6 chunks
            int startx = selfx - Map.ChunkSize * 2; // set update start x to update position x - 2 chunks
            int starty = selfy - Map.ChunkSize * 2; // set update start y to update position y - 2 chunks
            ...
            for (x = startx; x <= startx + width; x++) // move from start x to start x + width
            {
                for (y = starty + height; y >= starty; y--) // move from start x to start x + width
                {
                    if (x < 0 || x >= width || y < 0 || y >= height)
                        continue; // skip iteration if x or y is out of bounds

                    self = cells[x, y]; // set self variable to cell on current
                    if (self < 0)
                    {
                        cells[x, y] = -1;
                        continue;
            ...
            for (int j = selfy; j < selfy + viewHeight; j++)
            {
                ...
                for (int m = 0; m < march.Length; m++)
                {
                    (bool lu, bool u, bool ru, bool l, bool r, bool ld, bool d, bool rd,
                        (Vec2 a, Vec2 b, Vec2 c, byte at, byte bt, byte ct, Vec2 ac, Vec2 bc, Vec2 cc)[] triangles)
                        marching = march[m];
                    if ((marching.l ? bl : !bl) && (marching.r ? br : !br) && (marching.d ? bd : !bd) &&
                        (marching.u ? bu : !bu) &&
                        (marching.rd ? brd : !brd) && (marching.ru ? bru : !bru) && (marching.ld ? bld : !bld) &&
                        (marching.lu ? blu : !blu))
                    {
                    ...
                    if ((marching.r ? bl : !bl) && (marching.l ? br : !br) && (marching.u ? bd : !bd) &&
                        (marching.d ? bu : !bu) &&
                        (marching.lu ? brd : !brd) && (marching.ld ? bru : !bru) && (marching.ru ? bld : !bld) &&
                        (marching.rd ? blu : !blu))
                    {
                        foreach (var (a, b, c, at, bt, ct, ac, bc, cc) in marching.triangles)
                        {
                    ...
                    if ((marching.u ? bl : !bl) && (marching.d ? br : !br) && (marching.l ? bd : !bd) &&
                        (marching.r ? bu : !bu) &&
                        (marching.ld ? brd : !brd) && (marching.rd ? bru : !bru) && (marching.lu ? bld : !bld) &&
                        (marching.ru ? blu : !blu))
                    {
                        foreach (var (a, b, c, at, bt, ct, ac, bc, cc) in marching.triangles)
                        {
                            ...
                            batch.Vertex(
                                (new Vec2(i, j) + ICX(IC(new Vec2(ac.Y, ac.X))) - IX(new Vec2(a.Y, a.X)) * ap) *
                                Map.TileSize);
                            batch.Vertex(
                                (new Vec2(i, j) + ICX(IC(new Vec2(bc.Y, bc.X))) - IX(new Vec2(b.Y, b.X)) * bp) *
                                Map.TileSize);
                            batch.Vertex(
                                (new Vec2(i, j) + ICX(IC(new Vec2(cc.Y, cc.X))) - IX(new Vec2(c.Y, c.X)) * cp) *
                                Map.TileSize);
                        }
                    ...
                    if ((marching.d ? bl : !bl) && (marching.u ? br : !br) && (marching.r ? bd : !bd) &&
                        (marching.l ? bu : !bu) &&
                        (marching.ru ? brd : !brd) && (marching.lu ? bru : !bru) && (marching.rd ? bld : !bld) &&
                        (marching.ld ? blu : !blu))
                    {
                        foreach (var (a, b, c, at, bt, ct, ac, bc, cc) in marching.triangles)
                        {
                            ...
                            batch.Vertex((new Vec2(i, j) + ICX(new Vec2(ac.Y, ac.X)) + IX(new Vec2(a.Y, a.X)) * ap) *
                                         Map.TileSize);
                            batch.Vertex((new Vec2(i, j) + ICX(new Vec2(bc.Y, bc.X)) + IX(new Vec2(b.Y, b.X)) * bp) *
                                         Map.TileSize);
                            batch.Vertex((new Vec2(i, j) + ICX(new Vec2(cc.Y, cc.X)) + IX(new Vec2(c.Y, c.X)) * cp) *
                                         Map.TileSize);
                        }
                    ...
                    if ((marching.r ? bl : !bl) && (marching.l ? br : !br) && (marching.d ? bd : !bd) &&
                        (marching.u ? bu : !bu) &&
                        (marching.ld ? brd : !brd) && (marching.lu ? bru : !bru) && (marching.rd ? bld : !bld) &&
                        (marching.ru ? blu : !blu))
                    {
                        foreach (var (a, b, c, at, bt, ct, ac, bc, cc) in marching.triangles)
                        {
                    ...
                    if ((marching.l ? bl : !bl) && (marching.r ? br : !br) && (marching.u ? bd : !bd) &&
                        (marching.d ? bu : !bu) &&
                        (marching.ru ? brd : !brd) && (marching.rd ? bru : !bru) && (marching.lu ? bld : !bld) &&
                        (marching.ld ? blu : !blu))
                    {
                        foreach (var (a, b, c, at, bt, ct, ac, bc, cc) in marching.triangles)
                        {
                    ...
                    if ((marching.d ? bl : !bl) && (marching.u ? br : !br) && (marching.l ? bd : !bd) &&
                        (marching.r ? bu : !bu) &&
                        (marching.lu ? brd : !brd) && (marching.ru ? bru : !bru) && (marching.ld ? bld : !bld) &&
                        (marching.rd ? blu : !blu))
                    {
                        foreach (var (a, b, c, at, bt, ct, ac, bc, cc) in marching.triangles)
                        {
                            ...
                            batch.Vertex((new Vec2(i, j) + IC(new Vec2(ac.Y, ac.X)) - new Vec2(a.Y, a.X) * ap) *
                                         Map.TileSize);
                            batch.Vertex((new Vec2(i, j) + IC(new Vec2(bc.Y, bc.X)) - new Vec2(b.Y, b.X) * bp) *
                                         Map.TileSize);
                            batch.Vertex((new Vec2(i, j) + IC(new Vec2(cc.Y, cc.X)) - new Vec2(c.Y, c.X) * cp) *
                                         Map.TileSize);
                        }
                    ...
                    if ((marching.u ? bl : !bl) && (marching.d ? br : !br) && (marching.r ? bd : !bd) &&
                        (marching.l ? bu : !bu) &&
                        (marching.rd ? brd : !brd) && (marching.ld ? bru : !bru) && (marching.ru ? bld : !bld) &&
                        (marching.lu ? blu : !blu))
                    {
                        foreach (var (a, b, c, at, bt, ct, ac, bc, cc) in marching.triangles)
                        {
                            ...
                            batch.Vertex((new Vec2(i, j) + new Vec2(ac.Y, ac.X) + new Vec2(a.Y, a.X) * ap) *
                                         Map.TileSize);
                            batch.Vertex((new Vec2(i, j) + new Vec2(bc.Y, bc.X) + new Vec2(b.Y, b.X) * bp) *
                                         Map.TileSize);
                            batch.Vertex((new Vec2(i, j) + new Vec2(cc.Y, cc.X) + new Vec2(c.Y, c.X) * cp) *
                                         Map.TileSize);
                        }
        ...
        private float GetByType(byte type, bool ix, bool iy, bool rot, float s, float l, float r, float d, float u,
            float lu, float ld, float ru, float rd)
        {
            if (rot)
            {
                if (ix && iy)
         ...
         * 9 - ignore
         */
        readonly (bool lu, bool u, bool ru, bool l, bool r, bool ld, bool d, bool rd, (Vec2 a, Vec2 b, Vec2 c, byte at,
            byte bt, byte ct, Vec2 ac, Vec2 bc, Vec2 cc)[])[]
            march =
                new (bool, bool, bool, bool, bool, bool, bool, bool, (Vec2, Vec2, Vec2, byte, byte, byte, Vec2, Vec2,
                    Vec2)[])[]
                    {
                        #region 1
                        ...
                        (
                            ...
                            {
                                (new(0, .5f), new(0, -.5f), new(-.5f, 0), 0, 0, 0, new(.5f, .5f), new(.5f, .5f),
                                    new(.5f, .5f)),
                                (new(0, .5f), new(0, -.5f), new(.5f, 0), 0, 0, 0, new(.5f, .5f), new(.5f, .5f),
                                    new(.5f, .5f)),
                            }),
                        ...
                        (
                            ...
                            new (Vec2, Vec2, Vec2, byte, byte, byte, Vec2, Vec2, Vec2)[]
                            {
                                (new(.5f, 0), new(-.5f, 0), new(.5f, .5f), 3, 3, 0, new(.5f, 1), new(.5f, 1),
                                    new(.5f, .5f)),
                                (new(-.5f, 0), new(.5f, .5f), new(-.5f, -.5f), 3, 0, 0, new(.5f, 1), new(.5f, .5f),
                                    new(.5f, .5f)),
                                (new(0, .5f), new(0, -.5f), new(.5f, .5f), 2, 2, 0, new(1, .5f), new(1, .5f),
                                    new(.5f, .5f)),
                                (new(0, -.5f), new(.5f, .5f), new(-.5f, -.5f), 2, 0, 0, new(1, .5f), new(.5f, .5f),
                                    new(.5f, .5f)),
                            }),
                        (
                            false, false, true,
                        ...
                        (
                            ...
                            new (Vec2, Vec2, Vec2, byte, byte, byte, Vec2, Vec2, Vec2)[]
                            {
                                (new(-.5f, 0), new(.5f, 0), new(.5f, 0), 3, 3, 0, new(.5f, 1), new(.5f, 1),
                                    new(.5f, .5f)),
                                (new(-.5f, 0), new(-.5f, 0), new(.5f, 0), 3, 0, 0, new(.5f, 1), new(.5f, .5f),
                                    new(.5f, .5f)),
                                (new(-.5f, 0), new(.5f, 0), new(.5f, 0), 4, 4, 0, new(.5f, 0), new(.5f, 0),
                                    new(.5f, .5f)),
                                (new(-.5f, 0), new(-.5f, 0), new(.5f, 0), 4, 0, 0, new(.5f, 0), new(.5f, .5f),
                                    new(.5f, .5f)),
                            }),
                        (
                            false, true, true,
                        ...
                        (
                            ...
                            new (Vec2, Vec2, Vec2, byte, byte, byte, Vec2, Vec2, Vec2)[]
                            {
                                (new(0, .5f), new(0, -.5f), new(-.5f, 0), 1, 1, 4, new(0, .5f), new(0, .5f),
                                    new(.5f, 0)),
                                (new(0, .5f), new(0, -.5f), new(.5f, 0), 2, 2, 4, new(1, .5f), new(1, .5f),
                                    new(.5f, 0)),
                                (new(0, .5f), new(0, .5f), new(-.5f, 0), 2, 1, 4, new(1, .5f), new(0, .5f),
                                    new(.5f, 0)),
                                (new(0, .5f), new(.5f, 0), new(-.5f, 0), 2, 4, 4, new(1, .5f), new(.5f, 0),
                                    new(.5f, 0)),
                            }),
                        (
                            false, true, false,
                        ...
                        (
                            ...
                            new (Vec2, Vec2, Vec2, byte, byte, byte, Vec2, Vec2, Vec2)[]
                            {
                                (new(0, -.5f), new(-.5f, 0), new(.5f, 0), 1, 4, 4, new(0, .5f), new(.5f, 0),
                                    new(.5f, 0)),
                                (new(0, -.5f), new(0, .5f), new(.5f, 0), 1, 1, 4, new(0, .5f), new(0, .5f),
                                    new(.5f, 0)),
                                (new(0, .5f), new(-.5f, 0), new(.5f, 0), 1, 3, 4, new(0, .5f), new(.5f, 1),
                                    new(.5f, 0)),
                                (new(.5f, 0), new(-.5f, 0), new(.5f, 0), 3, 3, 4, new(.5f, 1), new(.5f, 1),
                                    new(.5f, 0)),
                                (new(.5f, 0), new(0, .5f), new(.5f, 0), 3, 2, 4, new(.5f, 1), new(1, .5f), new(.5f, 0)),
                                (new(0, -.5f), new(0, .5f), new(.5f, 0), 3, 2, 4, new(1, .5f), new(1, .5f),
                                    new(.5f, 0)),
                            }),
                    };
    }
