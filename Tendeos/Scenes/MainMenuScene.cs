...
namespace Tendeos.Scenes
{
    public class MainMenuScene : Scene
    {
        ...
        public override void InitGUI()
        {
            ...
            GUIElement loadPlane = new Window(Vec2.Zero, new FRectangle(0, 13, 65, 43), Core.WindowStyle)
                .Add(new ScrollButtons<string>(Vec2.Zero, new FRectangle(2, 2, 60, 39), Core.ScrollButtonsStyle,
                    ...
                    Icon<string>.From((batch, rect, value) => { batch.Text(Core.Font, value, rect.Center); }), 3,
                    saves.ToArray()));
            ...
            InputField seedField = new InputField(Vec2.Zero, new Vec2(22, 13), 30, Core.InputFieldStyle,
                Core.UnsignedNumbers);
            for (int i = 0; i < 9; i++)
            ...
            settingsPlane = new WindowFiller(Game.camera, Core.WindowFillerStyle)
                .Add(new Window(new Vec2(0.5f), new FRectangle(0, 0, 70, 35), Core.LabelWindowStyle,
                        Core.Text2Icon("settings"))
                    ...
                    .Add(new EnumSwitcher<ShadowMatrix.SmoothPower>(new Vec2(0.5f, 1), new FRectangle(0, -13, 66, 10),
                        Core.Font, Core.ButtonStyle,
            ...
            playPlane = new Window(Vec2.Zero, new FRectangle(60, 0, 65, 56), Core.WindowStyle)
                .Add(new Button(Vec2.Zero, new FRectangle(2, 2, 61, 10),
                    ...
                    Core.ButtonStyle,
                    Icon.From((batch, rect) => batch.Text(Core.Font,
                        playLoadOn ? Localization.Translate("game_new") : Localization.Translate("game_load"),
                        rect.Center))
                ))
                .Add(loadPlane);
        ...
        {
            //spriteBatch.Rect(Game.Assets.GetSprite("font_ll"), Vec2.Zero);
        }
