...
namespace XnaGame.Utils.Graphics
{
    public static class DrawSprite
    {
        ...
        public static void Text(this SpriteBatch spriteBatch, DynamicSpriteFontScaled font, string text, Vec2 position, float scale = 1, float depth = 0, Origin xOrigin = Origin.Center, Origin yOrigin = Origin.Center) =>
            Text(spriteBatch, font, Color.White, text, position, scale, depth, xOrigin, yOrigin);

        public static void Text(this SpriteBatch spriteBatch, DynamicSpriteFontScaled font, string text, Vec2 position, Vec2? scale, float depth = 0, Origin xOrigin = Origin.Center, Origin yOrigin = Origin.Center) =>
            Text(spriteBatch, font, Color.White, text, position, scale, depth, xOrigin, yOrigin);

        public static void Text(this SpriteBatch spriteBatch, DynamicSpriteFontScaled font, Color color, string text, Vec2 position, float scale = 1, float depth = 0, Origin xOrigin = Origin.Center, Origin yOrigin = Origin.Center)
        {
        ...
        public static void Text(this SpriteBatch spriteBatch, DynamicSpriteFontScaled font, Color color, string text, Vec2 position, Vec2? scale, float depth = 0, Origin xOrigin = Origin.Center, Origin yOrigin = Origin.Center)
        {
